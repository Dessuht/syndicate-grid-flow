    ...
    <div className="p-4 h-full flex flex-col">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <Button variant="outline" onClick={() => purchaseIntel(500)} disabled={cash < 500} className="gap-2">
          <ShoppingCart className="w-4 h-4" /> Buy Intel ($500)
        </Button>
      </div>
            ...
            {selectedRivalData ? (
              <motion.div 
                ...
                className={cn(
                  ...
                  selectedRivalData.relationship > 20 
                ...
                <div className="space-y-2">
                  {!selectedRivalData.hasTradeAgreement && (
                    <Button 
                      ...
                      disabled={cash < 1000}
                    >
                      <TrendingUp className="w-4 h-4" /> Trade ($1,000)
                    </Button>
                  )}
                  ...
                  {!selectedRivalData.hasAlliance && (
                    ...
                    >
                      <Handshake className="w-4 h-4" /> Alliance {selectedRivalData.relationship < 30 && '(+30)'}
                    </Button>
                  )}
